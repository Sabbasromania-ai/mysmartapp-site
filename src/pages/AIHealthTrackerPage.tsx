...
/* ── MOBILE PHONE (embedded in copy column) ── */
.aht-phone-mobile {
  display: none;
}
...
@media (max-width: 768px) {
  ...
  .aht-phone-mobile .heroPhoneImage {
            ...
            <div className="aht-copy">
              ...
              <div className="aht-identity">
                ...
                <div>
                  ...
                  <div className="aht-appsub">{t('aht_appsub')}</div>
                </div>
              </div>

              <h1 className="aht-headline">
                {t('aht_h1_1')}<br />
                <span className="green">{t('aht_h1_2')}</span><br />
                {t('aht_h1_3')}
              </h1>

              <p className="aht-text">{t('aht_desc')}</p>

              {/* Mobile-only phone mockup — appears between description and chips */}
              <div className="aht-phone-mobile">
                <img src={heroPhoneCutout} alt="App Mockup" className="heroPhoneImage" />
              </div>
              ...
              <div className="aht-stores">
                ...
                <a href="https://apps.apple.com/ro/app/mounjaro-tracker-ai-health/id6761938987" target="_blank" rel="noopener noreferrer" className="aht-storebtn">
                  ...
                  <div className="aht-storebtn-text">
                    <span className="ssub">{t('aht_store_sub')}</span>
                    <span className="smain">{t('aht_store_apple')}</span>
                  </div>
                </a>
                {/* Google Play badge */}
                <a href="#" className="aht-storebtn">
                  ...
                  <div className="aht-storebtn-text">
                    <span className="ssub">{t('aht_store_google_sub')}</span>
                    <span className="smain">{t('aht_store_google')}</span>
                  </div>
                </a>
              </div>
      ...
      <section className="aht-ita-section">
        <div className="aht-ita-card">
          ...
          <div className="aht-ita-header">
            <div className="aht-ita-eyebrow">{t('aht_ita_eyebrow')}</div>
            <h2 className="aht-ita-title">{t('aht_ita_title')}</h2>
            <p className="aht-ita-sub">{t('aht_ita_sub')}</p>
          </div>
          ...
          <div className="aht-ita-inforow">
            <div className="aht-ita-infoitem">
              ...
              <div>
                ...
                <div className="aht-ita-info-label">{t('aht_ita_ratings_label')}</div>
            ...
            <div className="aht-ita-infoitem">
              ...
              <div>
                ...
                <div className="aht-ita-info-label">{t('aht_ita_screens_label')}</div>
                <div className="aht-ita-info-sub">{t('aht_ita_screens_sub')}</div>
              </div>
            </div>
            <div className="aht-ita-infoitem">
              <div className="aht-ita-info-icon">
              ...
              <div>
                ...
                <div className="aht-ita-info-label">{t('aht_ita_ai_label')}</div>
                <div className="aht-ita-info-sub">{t('aht_ita_ai_sub')}</div>
              </div>
            </div>
          </div>
